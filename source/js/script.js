...
document.addEventListener('DOMContentLoaded', function() {
    var mymap = L.map('mapid').setView([-3.319394, 114.590216], 13); // Koordinat Banjarmasin

    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
        attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
    }).addTo(mymap);

    var marker = L.marker([-3.319394, 114.590216]).addTo(mymap);
    marker.bindPopup("<b>PT. Antar Nusa Raya Ekspress</b><br>Kantor Pusat Banjarmasin.").openPopup();
});